...
<body>
<form action="<?= \yii\helpers\Url::to(['salereport/indexupdate'], true) ?>" method="post">
    <div class="row">
...
<br/>
<form action="<?= \yii\helpers\Url::to(['salereport/saveupdate'], true) ?>" method="post" id="form-search">
<div id="div1">
    ...
    <table style="width: 100%" id="table-data">
        <tr>
            ...
            <td style="text-align: center;padding: 0px;border: 1px solid grey;width: 10%">เลขที่ใบส่งของ</td>
        ...
        <?php if ($model_line != null): ?>
            <?php foreach ($model_line as $value): ?>
                ...
                ?>
                <tr>
                    <td style="text-align: center;padding: 10px;border: 1px solid grey"><?= $num ?><input type="hidden" name="order_id[]" value="<?= $value->id ?>"></td>
                    ...
                    <td style="text-align: center;padding: 0px;padding-right: 5px;border: 1px solid grey">
                        <?php
                          $cusref_no = findCustomerRefNo($value->id);
                        ?>
