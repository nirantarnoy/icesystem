...
<!--                                <input type="hidden" class="line-total-amount" value="--><?//=$line_total_amt?><!--">-->
            ...
            <tfoot>
              <tr>
                  <td style="text-align: right;border-top: 2px solid black;border-bottom: 2px solid black;padding: 5px;border-left: 2px solid black"></td>
                  <td style="text-align: right;border-top: 2px solid black;border-bottom: 2px solid black;padding: 5px;"></td>
                  <td style="text-align: right;border-top: 2px solid black;border-bottom: 2px solid black;padding: 5px;border-right: 2px solid black"></td>
                  <td style="text-align: right;border-top: 2px solid black;border-bottom: 2px solid black;padding: 5px;"><b><?=number_format($total_qty,2)?></b></td>
                  <td style="text-align: right;border-top: 2px solid black;border-bottom: 2px solid black;padding: 5px;"><b><?=number_format($total_qty2,2)?></b></td>
                  <td style="text-align: right;border-top: 2px solid black;border-bottom: 2px solid black;padding: 5px;"><b><?=number_format($total_qty5,2)?></b></td>
                  <td style="text-align: right;border-top: 2px solid black;border-bottom: 2px solid black;padding: 5px;"><b><?=number_format($total_qty4,2)?></b></td>
                  <td style="text-align: right;border-top: 2px solid black;border-bottom: 2px solid black;padding: 5px;border-right: 2px solid black"><b><?=number_format($total_qty_all,2)?></b></td>
                  <td style="text-align: right;border-top: 2px solid black;border-bottom: 2px solid black;padding: 5px;"><b><?=number_format($total_amount,2)?></b></td>
                  <td style="text-align: right;border-top: 2px solid black;border-bottom: 2px solid black;padding: 5px;"><b><?=number_format($total_amount2,2)?></b></td>
                  <td style="text-align: right;border-top: 2px solid black;border-bottom: 2px solid black;padding: 5px;"><b><?=number_format($total_amount5,2)?></b></td>
                  <td style="text-align: right;border-top: 2px solid black;border-bottom: 2px solid black;padding: 5px;"><b><?=number_format($total_amount4,2)?></b></td>
                  <td style="text-align: right;border-top: 2px solid black;border-bottom: 2px solid black;padding: 5px;border-right: 2px solid black"><b><?=number_format($total_amount_all,2)?></b></td>
              </tr>
            </tfoot>
        </table>
    </div>
